...
Source0  : https://files.pythonhosted.org/packages/72/cf/17f878e456303077165bddaf012e0ccb5677a01c88ef2d4b2f4ecb63ec46/json5-0.9.7.tar.gz
...
%prep
%setup -q -n json5-0.9.7
cd %{_builddir}/json5-0.9.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651945797
...
cp %{_builddir}/json5-0.9.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-json5/c700a8b9312d24bdc57570f7d6a131cf63d89016
