...
%prep
%setup -q -n json5-0.9.6
cd %{_builddir}/json5-0.9.6
...
cp %{_builddir}/json5-0.9.6/LICENSE %{buildroot}/usr/share/package-licenses/pypi-json5/c700a8b9312d24bdc57570f7d6a131cf63d89016
