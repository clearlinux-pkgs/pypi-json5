...
Source0  : https://files.pythonhosted.org/packages/92/96/ca78f50cffb5fd1995edea469b6c79d9420c8aaeaf7f71f58c823e4f9651/json5-0.9.17.tar.gz
...
%prep
%setup -q -n json5-0.9.17
cd %{_builddir}/json5-0.9.17
pushd ..
cp -a json5-0.9.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708442120
