...
%prep
%setup -q -n json5-0.9.8
cd %{_builddir}/json5-0.9.8
pushd ..
cp -a json5-0.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656397545
...
cp %{_builddir}/json5-0.9.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-json5/c700a8b9312d24bdc57570f7d6a131cf63d89016
